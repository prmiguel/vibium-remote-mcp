...
priority=20
command=bash -c "nohup node /home/seluser/supergateway/dist/index.js --stdio 'npx -y vibium' --outputTransport streamableHttp --stateful --sessionTimeout 60000 --port 8000 > /tmp/supergateway.log 2>&1 &"
stopasgroup = true
autostart=true
autorestart=false
startsecs=0
